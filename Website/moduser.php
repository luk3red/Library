...
<form action="http://localhost/mioserver/moduser2.php" method="post">
  <div class="container">
    ...
    <input type="text" placeholder="Inserisci il tuo nome" name="username" id="username" required>
