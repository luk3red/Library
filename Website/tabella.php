...
//.isset($_POST['lukered']
$get_data = callAPI('GET', 'http://localhost:8080/Library/WebServiceGet/UserP/'.$username, false, false);
...
<?php
	...
	<td><input  type = "text" name = "ID" value = "<?php echo $result['id']; ?>" readonly></td>
            ...
            <td><form action="http://localhost/mioserver/modifica2.php" method="post"> <input type="hidden" value = "<?php echo $result['id']; ?>" name="id" required> <button type="submit">MODIFICA</button></form></td>
